package sleys.efedp.neoforge.conditions.entity;
...
public class InnateSkillDataKeyBooleanCondition extends Condition.EntityPatchCondition {
    private ResourceLocation skillBooleanDataKey;
    private Boolean expectedValue;

    @Override
    public InnateSkillDataKeyBooleanCondition read(CompoundTag tag) {
    ...
    public boolean predicate(LivingEntityPatch<?> entityPatch) {
        ...
        DeferredHolder<SkillDataKey<?>, SkillDataKey<Boolean>> skillDataKey = SkillDataKeyCache.getSkillDataKey(
                skillBooleanDataKey,
                Boolean.class
        );
        ...
        if (skillManager.getDataValue(skillDataKey) instanceof Boolean boolValue) {
