package sleys.efedp.neoforge.system.animations.json.properties.datapackets.write;
...
import sleys.efedp.neoforge.system.animations.json.properties.datapackets.DataPacketType;
import sleys.efedp.neoforge.system.animations.json.properties.datapackets.instruction.StringInstruction;
...
public record WriteStringData(DataPacketType type, String dataId,
    ...
    public void writeData(LivingEntity livingEntity) {
        ...
        var currentValue = data.getString(dataId);
        var outputValue = instruction.apply(currentValue, value);
        data.putString(dataId, outputValue);
    }
}
