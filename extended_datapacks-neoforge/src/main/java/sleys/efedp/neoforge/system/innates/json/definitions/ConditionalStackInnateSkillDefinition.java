...
import sleys.efedp.neoforge.system.innates.json.builder.data.ConditionalStackAnimationData;
...
public record ConditionalStackInnateSkillDefinition(
...
) implements IInnateSkillDefinition<WConditionalStackInnateSkill.Builder> {
    ...
    public WConditionalStackInnateSkill.Builder createBuilder() {
        return WConditionalStackInnateSkill.createConditionalBuilder(WConditionalStackInnateSkill::new)
