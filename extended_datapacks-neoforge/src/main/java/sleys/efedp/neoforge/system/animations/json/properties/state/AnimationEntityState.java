package sleys.efedp.neoforge.system.animations.json.properties.state;
...
public record AnimationEntityState<T extends StaticAnimation>(
    ...
    public void applyState(T animation) {
        ...
        comboAttackDoable.ifPresent(comboAttackDoable -> animation.addState(EntityState.COMBO_ATTACKS_DOABLE, comboAttackDoable));

        skillExecutable.ifPresent(skillExecutable -> animation.addState(EntityState.SKILL_EXECUTABLE, skillExecutable));
        ...
        lookTarget.ifPresent(lookTarget -> animation.addState(EntityState.LOOK_TARGET, lookTarget));
