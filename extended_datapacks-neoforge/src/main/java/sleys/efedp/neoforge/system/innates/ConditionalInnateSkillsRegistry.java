...
import sleys.efedp.neoforge.system.innates.json.builder.wrapper.conditional.WConditionalInnateSkill;
...
import sleys.efedp.neoforge.system.innates.json.builder.ConditionalInnateSkillBuilder;
...
import sleys.efedp.neoforge.system.innates.json.definitions.ConditionalInnateSkillDefinition;
...
public class ConditionalInnateSkillsRegistry {
    ...
    private static Skill buildSkillSafely(DeferredRegister<Skill> registry,
        ...
        return ExecutionTasks.getRaw(
                        ...
                        () -> buildSkill(registry, builder, modId, name, skillData, key)
                )
                ...
                .peekError(error -> ExtendedDatapacks.LOGGER.fatal(
                        "[Conditional Innate Skill Registry] Error Stack: ", error)
                )
                .fold(
                        skill -> skill,
