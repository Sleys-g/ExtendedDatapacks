...
import sleys.efedp.neoforge.system.innates.json.builder.wrapper.holdable.WHoldableInnateSkill;
import sleys.efedp.neoforge.system.innates.json.builder.values.HoldableSkillValues;
import sleys.efedp.neoforge.system.innates.json.builder.values.ListenerSkillValues;
...
public record HoldableInnateSkillDefinition(
...
) implements IInnateSkillDefinition<WHoldableInnateSkill.Builder> {
    ...
    public WHoldableInnateSkill.Builder createBuilder(
        ...
        return WHoldableInnateSkill
                .createHoldableInnateSkillBuilder(WHoldableInnateSkill::new)
    ...
    @Override
    public void applyProperties(WHoldableInnateSkill.Builder builder) {
