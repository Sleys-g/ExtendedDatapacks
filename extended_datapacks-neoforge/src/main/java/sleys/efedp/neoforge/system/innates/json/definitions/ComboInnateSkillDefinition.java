...
import sleys.efedp.neoforge.system.innates.json.builder.data.ComboEntryPointData;
import sleys.efedp.neoforge.system.innates.json.builder.data.ComboNodeData;
