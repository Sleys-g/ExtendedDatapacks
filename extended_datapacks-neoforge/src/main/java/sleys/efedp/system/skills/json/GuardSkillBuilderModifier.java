...
public class GuardSkillBuilderModifier {
    private static final Map<String, List<GuardSkillBuilderModifier.RawGuardBuilderData>> SKILL_GUARD_BUILD_DATA = new ConcurrentHashMap<>();
    ...
    private static void startToProcessGuardEntry(JsonObject root, String fileName) {
        ...
        for (JsonElement element : array) {
            ...
            GuardSkillBuilderModifier.RawGuardBuilderData data = startToParse(element.getAsJsonObject(), fileName);
    ...
    private static GuardSkillBuilderModifier.RawGuardBuilderData startToParse(JsonObject json, String fileName) {
        ...
        return new GuardSkillBuilderModifier.RawGuardBuilderData(
                skillId,
                category,
                guardMotionData,
    ...
    @Nullable
    public static List<GuardSkillBuilderModifier.RawGuardBuilderData> get(String skillId) {
