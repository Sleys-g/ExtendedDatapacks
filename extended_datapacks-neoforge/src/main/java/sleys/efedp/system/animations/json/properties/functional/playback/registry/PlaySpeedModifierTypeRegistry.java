package sleys.efedp.system.animations.json.properties.functional.playback.registry;
...
public final class PlaySpeedModifierTypeRegistry {
    ...
    public static void register(String modId, Class<? extends Enum<?>> enumClass) {
        ...
        ExtendedDatapacks.LOGGER.info("[Play Speed Modifier - Registry] Attempting to register the playback speed class: {} for: {}", enumClass.getSimpleName(), modId);
    ...
    public static IPlaySpeedModifierType get(String key) {
        ...
        if (type != null) {
            ExtendedDatapacks.LOGGER.info("[Play Speed Modifier - Registry] Successful recovery for event type: {}", defaultKey);
            return type;
        }
