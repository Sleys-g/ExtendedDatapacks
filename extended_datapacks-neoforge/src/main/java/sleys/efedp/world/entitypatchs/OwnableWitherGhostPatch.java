...
public class OwnableWitherGhostPatch extends MobPatch<OwnableWitherGhost> {
    public OwnableWitherGhostPatch(OwnableWitherGhost entity) {
        super(entity);
    }

    @Override
    public void onJoinWorld(OwnableWitherGhost entity, Level level, boolean worldgenSpawn) {
    ...
    public static void initAttributes(EntityAttributeModificationEvent event) {
        event.add(ExtendedDatapacksEntities.OWNABLE_WITHER_GHOST.get(), EpicFightAttributes.IMPACT, 3.0D);
    }
