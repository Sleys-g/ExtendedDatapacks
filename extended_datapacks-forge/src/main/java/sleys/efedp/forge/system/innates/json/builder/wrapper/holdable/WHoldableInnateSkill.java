package sleys.efedp.forge.system.innates.json.builder.wrapper.holdable;
...
import sleys.efedp.forge.system.innates.json.builder.values.HoldableSkillValues;
import sleys.efedp.forge.system.innates.json.builder.values.ListenerSkillValues;
...
public class WHoldableInnateSkill extends WeaponInnateSkill implements ChargeableSkill, IOnMovementInputEFSkillEvent  {
    ...
    public void onStopHolding(SkillContainer container, SPSkillExecutionFeedback feedback) {
        container.getExecutor().getAnimator().getVariables().put(
                ...
                this.animation, container.getExecutor().getAccumulatedChargeAmount()
        );
    ...
    public static final class Builder extends SkillBuilder<WHoldableInnateSkill> {
        ...
        public Builder setAnimation(AnimationManager.AnimationAccessor<? extends StaticAnimation> animation) {
            this.animation = animation;
            return this;
        }

        public Builder setChargingAnimation(AnimationManager.AnimationAccessor<? extends StaticAnimation> chargingAnimation) {
        ...
        public Builder setListenerValues(ListenerSkillValues listenerValues) {
            this.listenerValues = listenerValues;
            return this;
        }

        public Builder setHoldableValues(HoldableSkillValues holdableValues) {
