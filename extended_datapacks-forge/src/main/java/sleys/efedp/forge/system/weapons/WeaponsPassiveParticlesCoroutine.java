package sleys.efedp.forge.system.weapons;
...
public class WeaponsPassiveParticlesCoroutine extends CoroutineTask {
    private final MutableSimpleParticleEmitter emitter = new MutableSimpleParticleEmitter(null);
    private final Minecraft mc = Minecraft.getInstance();

    public WeaponsPassiveParticlesCoroutine() {
    ...
    private void inViewerRendering(Player player) {
        ...
        for (InteractionHand hand : InteractionHand.values()) {
            ...
            List<WeaponsPassiveParticleBuilder.PassiveParticleEntry> emitters = WeaponsPassiveParticleBuilder.getEntries(rlItem, style);
            for (WeaponsPassiveParticleBuilder.PassiveParticleEntry emitter : emitters) {
