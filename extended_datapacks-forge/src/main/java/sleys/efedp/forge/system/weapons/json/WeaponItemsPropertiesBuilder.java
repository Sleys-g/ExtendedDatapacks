package sleys.efedp.forge.system.weapons.json;
...
public class WeaponItemsPropertiesBuilder extends SimplePreparableReloadListener<Map<ResourceLocation, JsonElement>> {
    ...
    public static Optional<WeaponItemPropertyData> getSafeEntry(InteractionHand hand, Player player) {
        ...
        return WeaponItemsPropertiesBuilder.getEntry(stackRL);
    }
