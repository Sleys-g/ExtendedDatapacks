package sleys.efedp.forge.system.animations.json.properties.time;

import com.mojang.serialization.*;
import sleys.efedp.forge.ExtendedDatapacks;
import sleys.efedp.forge.system.animations.json.properties.helpers.AnimationEventSideCodec;
    ...
    public static <T extends StaticAnimation> Codec<AnimationsOnProcessEvent<T>> codec() {
        return new MapCodec<AnimationsOnProcessEvent<T>>() {
            ...
            public <O> DataResult<AnimationsOnProcessEvent<T>> decode(DynamicOps<O> ops, MapLike<O> input) {
                ...
                DataResult<AnimationsOnProcessEvent<T>> result = ProcessType.CODEC.parse(ops, processTypeRaw).flatMap(processType -> {
