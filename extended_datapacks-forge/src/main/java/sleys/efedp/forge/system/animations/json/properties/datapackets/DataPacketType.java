package sleys.efedp.forge.system.animations.json.properties.datapackets;

import com.mojang.serialization.Codec;
import com.mojang.serialization.MapCodec;
import net.minecraft.nbt.CompoundTag;
import net.minecraft.world.entity.LivingEntity;
import sleys.efedp.forge.system.animations.json.properties.datapackets.read.IDataRead;
import sleys.efedp.forge.system.animations.json.properties.datapackets.read.ReadArithmeticData;
import sleys.efedp.forge.system.animations.json.properties.datapackets.read.ReadLogicalData;
import sleys.efedp.forge.system.animations.json.properties.datapackets.read.ReadStringData;
import sleys.efedp.forge.system.animations.json.properties.datapackets.write.IDataWriter;
import sleys.efedp.forge.system.animations.json.properties.datapackets.write.WriteArithmeticData;
import sleys.efedp.forge.system.animations.json.properties.datapackets.write.WriteLogicalData;
import sleys.efedp.forge.system.animations.json.properties.datapackets.write.WriteStringData;
...
public enum DataPacketType {
    ...
    public Codec<? extends IDataWriter> writeCodecLegacy() {
        return this.writeCodec().codec();
    }

    @LegacyFunction(since = "1.21.1")
    public Codec<? extends IDataRead> readCodecLegacy() {
        return this.readCodec().codec();
    }
}