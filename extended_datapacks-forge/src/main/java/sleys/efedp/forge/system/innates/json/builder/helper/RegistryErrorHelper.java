package sleys.efedp.forge.system.innates.json.builder.helper;
...
public final class RegistryErrorHelper {
    ...
    public static void handleRegistrationError(SkillBuildEvent build, String modId, String name,
                                                Object animationId, List<String> errors,Exception e) {
        boolean isDupe = build.getAllSkills().stream()
                .anyMatch(registryId ->
                        ResourceLocation.fromNamespaceAndPath(modId, name).equals(registryId.getRegistryName()));
