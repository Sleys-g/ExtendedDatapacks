package sleys.efedp.forge.system.innates.json.builder.wrapper.conditional;
...
public class WConditionalDataInnateSkill extends WeaponInnateSkill {
    ...
    public static WConditionalDataInnateSkill.Builder createConditionalBuilder() {
        return new WConditionalDataInnateSkill.Builder()
    ...
    public static class Builder extends SkillBuilder<WConditionalDataInnateSkill> {
