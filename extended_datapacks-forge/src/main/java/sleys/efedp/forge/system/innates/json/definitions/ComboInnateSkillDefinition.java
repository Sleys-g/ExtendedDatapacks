...
import sleys.efedp.forge.system.innates.json.builder.data.ComboEntryPointData;
import sleys.efedp.forge.system.innates.json.builder.data.ComboNodeData;
...
) implements IInnateSkillDefinition<WComboInnateSkill> {
