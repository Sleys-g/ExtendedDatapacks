...
import sleys.efedp.forge.system.innates.json.builder.data.HoldableAnimationData;
...
import sleys.efedp.forge.system.innates.json.builder.wrapper.holdable.WHoldableConditionalInnateSkill;
...
public record HoldableConditionalInnateSkillDefinition(
...
) implements IInnateSkillDefinition<WHoldableConditionalInnateSkill> {
    ...
    public WHoldableConditionalInnateSkill.Builder createBuilder(
        ...
        return WHoldableConditionalInnateSkill
                .createHoldableConditionalInnateSkillBuilder()
