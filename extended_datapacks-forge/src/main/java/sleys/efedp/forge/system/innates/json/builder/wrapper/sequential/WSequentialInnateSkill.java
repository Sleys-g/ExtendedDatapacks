package sleys.efedp.forge.system.innates.json.builder.wrapper.sequential;
...
public class WSequentialInnateSkill extends WeaponInnateSkill {
    ...
    public static WSequentialInnateSkill.Builder createSequentialBuilder() {
        return new WSequentialInnateSkill.Builder()
    ...
    public void executeOnServer(SkillContainer container, FriendlyByteBuf arguments) {
        ...
        var skillValues = listSize <= counter ?
                this.animationSkillValues.get(listSize - 1) :
    ...
    public static final class Builder extends SkillBuilder<WSequentialInnateSkill> {
