...
public record VirtualAttackAnimationGroup(ResourceLocation realAnimation, ResourceLocation virtualAnimation,
                                          List<AttackPhaseProperties> properties) implements IAnimationVirtualization<AttackAnimation> {
    ...
    @Override
    public void configProtocol(IAnimationProperties<AttackAnimation> property) {
