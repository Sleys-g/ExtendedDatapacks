...
import sleys.efedp.forge.conditions.CommonUtilities;
import sleys.efedp.forge.conditions.ComparisonType;
...
public class InnateSkillDataKeyIntegerCondition extends Condition.EntityPatchCondition {
    private ResourceLocation skillIntegerDataKey;
    private Integer expectedValue;
    private ComparisonType comparisonType;

    @Override
    public InnateSkillDataKeyIntegerCondition read(CompoundTag tag) {
        ...
        if (tag.contains("comparison_type")) {
            ...
            this.comparisonType = ComparisonType.EQUAL; // Valor por defecto
        }
