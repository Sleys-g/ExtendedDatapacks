...
import sleys.efedp.forge.conditions.charged.ChargedAttackCondition;
import sleys.efedp.forge.conditions.entity.*;
...
public class ExtendedDatapacksConditions {
    ...
    public static void onRegisterEvent(RegisterEvent event) {
        ...
        if (registry == null) {
            ...
            ExtendedDatapacksConditions.registryConditions(registry);
        }
    }
