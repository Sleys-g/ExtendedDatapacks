...
import sleys.efedp.capability.skill.StacksMultiConditionalWeaponInnateSkill;
    ...
    public static void initialize(SkillBuildEvent build) {
        ...
        for (var entry : data.entrySet()) {
            ...
            for (var skillData : entry.getValue()) {
                ...
                var skillBuilder = StacksMultiConditionalWeaponInnateSkill.createMultiConditionalBuilder();
                ...
                try {
                    ...
                    modRegistry.build(name, key -> new StacksMultiConditionalWeaponInnateSkill(skillBuilder) {
